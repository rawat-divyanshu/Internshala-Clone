...
const JobSkillsAndAssesmentComponent = (props) => {
    ...
    <React.Fragment>
      ...
      <Container className={classes.formContainer}>
        <FormControl style={{ width: "100%" }} component="fieldset">
          <h4 className={classes.formText} style={{ marginBottom: "2px" }}>
          ...
          <Grid container spacing={0} style={{ paddingTop: "10px" }}>
            <Grid item xs={12}>
              <h4 className={classes.formText} style={{ marginTop: "-10px" }}>
              ...
              <TextareaAutosize
                ...
                value={CandidatePreference}
                onChange={handleInputChange("CandidatePreference")}
              />
            </Grid>
          </Grid>
          <h4 className={classes.formText} style={{ marginTop: "-8px" }}>
            Assesment
          </h4>
          <h4
            className={classes.formText}
            style={{ color: "#9E9E9E", fontSize: "17px" }}
          >
            Question 1 will be asked to every applicant by default. If you wish
            you may ask two more customized questions.
          </h4>
...
export default JobSkillsAndAssesmentComponent;
