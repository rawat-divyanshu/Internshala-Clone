...
const internshipFAQ = {
  "Getting Started": {
    "How do I hire Interns using Internshala ?": `1. Register yourself as an Employer here
...
const InternshipFAQComponent = () => {
  ...
  const renderQuestionList = () => {
    switch (currentTab) {
      case 0:
        return <FAQuestionsList qa={internshipFAQ["Getting Started"]} />;
      case 1:
        return <FAQuestionsList qa={internshipFAQ["Account"]} />;
      case 2:
        return <FAQuestionsList qa={internshipFAQ["Internships Posted"]} />;
      case 3:
        return <FAQuestionsList qa={internshipFAQ["Applications Received"]} />;
      case 4:
        return <FAQuestionsList qa={internshipFAQ["Candidates Selected"]} />;
      case 5:
      ...
      <Container maxWidth="lg">
        <Grid container spacing={0}>
          <Grid item sm={12} xs={12} className={classes.tabContainer}>
            ...
            >
              {Object.entries(internshipFAQ).map((entry, idx) => (
...
export default InternshipFAQComponent;
